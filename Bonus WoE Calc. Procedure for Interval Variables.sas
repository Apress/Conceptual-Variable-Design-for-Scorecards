LIBNAME ABT "/sasuser/data/CI360/Integration/MA_Upload_to_CI360/XSell/Miner_Output";

%LET DIR=/sasuser/data/CI360/Integration/MA_Upload_to_CI360/XSell/Miner_Output;
...
%let timestamp2 = %sysfunc(tranwrd(&timestamp.,:,_));
%let datetimestamp = &datestamp._%substr(&timestamp2.,1,5);
%LET LIB=TRMNT;
%LET MDL=GGD;
%LET TGT=KGB_&MDL._CUSTOMERS;
%LET FLG=FLG_&MDL.;
%LET TIME=3;
...
* WOE RECODING FILE                     *;
filename woefile "&DIR./&MDL._&datetimestamp._MONO_WOE.WOE";
 
* FORMAT FOR BINNING                    *;
filename fmtfile "&DIR./&MDL._&datetimestamp._MONO_WOE.FMT";
 
* PUT STATEMENT TO USE FORMAT           *;
filename binfile "&DIR./&MDL._&datetimestamp._MONO_WOE.PUT";
 
* KS SUMMARY                            *;
filename sumfile "&DIR./&MDL._&datetimestamp._MONO_WOE.SUM";
  
* STATISTICAL SUMMARY FOR EACH VARIABLE *;
filename outfile "&DIR./&MDL._&datetimestamp._MONO_WOE.OUT";
 
* IMPUTE RECODING FILE                  *;
filename impfile "&DIR./&MDL._&datetimestamp._MONO_WOE.IMP";
...
LIBNAME TRMNT BASE "/sasuser/data/CRM/Campaings/Treatments";
 

 
%num_woe(
data = TRMNT.ABT_CS_&MDL._PRTTN_TRAIN
,y = &TGT.
, x =
ANTIGUEDAD_ANIOS
AVG_LIN_6
