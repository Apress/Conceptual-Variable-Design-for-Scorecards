...
--|ABT: ABT
--|Operation:   Create
--|Description: Create account, time period catalog
--|Input:       TRX_INPUT_CC_ACC_GRP
--|Output:      ACCOUNT_TIME_PERIOD_CATALOG
-------------------------------------------------------------------------------------------|
...
--|Input:       TIME_PERIOD_CATALOG ACCOUNT_TIME_PERIOD_CATALOG EXPENSE_TYPE_CATALOG
--|Output:      TBT_INPUT_CC_ACC_GRP
-------------------------------------------------------------------------------------------|
...
--|Input:       TBT_INPUT_CC_ACC_GRP(PERIOD,ACCOUNT_ID,EXPENSE_TYPE_CODE) TRX_INPUT_CC_ACC_GRP(PERIOD,ACCOUNT_ID,EXPENSE_TYPE_CODE)
--|Output:      INX_TBT_INPUT_CC_ACC_GRP INX_TRX_INPUT_CC_ACC_GRP
-------------------------------------------------------------------------------------------|
...
--|Input:       TRX_INPUT_CC_ACC_GRP
--|Output:      TBT_TRX_INPUT_CC_ACC_GRP
-------------------------------------------------------------------------------------------|
DECLARE 
...
--|Input:       TBT_TRX_INPUT_CC_ACC_GRP
--|Output:      OAF_TBT_INPUT_CC_ACC_GRP
-------------------------------------------------------------------------------------------|
...
--|Input:       OAF_TBT_INPUT_CC_ACC_GRP
